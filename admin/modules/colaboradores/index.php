...
if($_GET){
    ...
    $sql_delete="SELECT * FROM tbl_colaboradores WHERE id = '$txtid'";
    ...
    $sql = "DELETE FROM tbl_colaboradores WHERE id = '$txtid'";
        ...
        <div style="overflow-x:auto; width:100%;">
            <table class="table table-striped table-hover table-bordered align-middle shadow-sm" style="background: #fff; border-radius: 10px; min-width: 900px;">
                ...
                <tbody class="table-group-divider text-center align-middle">
                    <?php
                    $slq = "SELECT * FROM tbl_colaboradores";
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo $row["linkfacebook"] ?>" target="_blank">Facebook</a></td>
                        <td><a href="<?php echo $row["linkinstagram"] ?>" target="_blank">Instagram</a></td>
                        <td><a href="<?php echo $row["linklinkedin"] ?>" target="_blank">LinkedIn</a></td>
                        <td><img src="../../../img/colaboradores/<?php echo $row["foto"] ?>" alt="Foto" style="width:40px; height:40px; object-fit:cover; border-radius:50%;"></td>
                        <td>
